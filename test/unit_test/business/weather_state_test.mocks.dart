...
// in weather_app/test/unit_test/business/weather_state_test.dart.
...
import 'package:weather_app/src/entity/country.dart' as _i4;
import 'package:weather_app/src/entity/weather.dart' as _i3;
...
class _FakeWeather_3 extends _i1.SmartFake implements _i3.Weather {
  _FakeWeather_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeCountry_4 extends _i1.SmartFake implements _i4.Country {
  _FakeCountry_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [RestfulWeatherService].
///
/// See the documentation for Mockito's code generation for more information.
class MockRestfulWeatherService extends _i1.Mock
    implements _i5.RestfulWeatherService {
  ...
  @override
  String getCountryByKeywordApi(String? keyword) => (super.noSuchMethod(
        Invocation.method(
          #getCountryByKeywordApi,
          [keyword],
        ),
        returnValue: '',
      ) as String);
  ...
  @override
  String getCountryByZipcodeApi(String? zipcode) => (super.noSuchMethod(
        Invocation.method(
          #getCountryByZipcodeApi,
          [zipcode],
        ),
        returnValue: '',
      ) as String);
  ...
  @override
  _i6.Future<_i3.Weather> getWeatherByCoordinate(
    String? countryName,
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i3.Weather>.value(_FakeWeather_3(
          this,
          Invocation.method(
            #getWeatherByCoordinate,
            [
  ...
  @override
  _i6.Future<_i4.Country> getCountryByKeyword(String? keyword) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCountryByKeyword,
          [keyword],
        ),
        returnValue: _i6.Future<_i4.Country>.value(_FakeCountry_4(
          this,
          Invocation.method(
            #getCountryByKeyword,
            [keyword],
      ...
      ) as _i6.Future<_i4.Country>);

  @override
  _i6.Future<_i4.Country> getCountryByZipcode(String? zipcode) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCountryByZipcode,
          [zipcode],
  ...
  @override
  _i3.Weather insertSearchWeatherHistory(_i3.Weather? weather) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertSearchWeatherHistory,
          [weather],
        ),
        returnValue: _FakeWeather_3(
          this,
          Invocation.method(
            #insertSearchWeatherHistory,
            [weather],
  ...
  @override
  Iterable<_i3.Weather> getSearchWeatherHistory(
    int? page,
    int? pageSize,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #getSearchWeatherHistory,
          [
            page,
            pageSize,
          ],
      ...
      ) as Iterable<_i3.Weather>);

  @override
  void clearSearchWeatherHistory() => super.noSuchMethod(
        Invocation.method(
          #clearSearchWeatherHistory,
          [],
        ),
        returnValueForMissingStub: null,
      );
  ...
  _i6.Future<_i2.GraphQLResponse<T>> query<T>(
    ...
    Map<String, String>? headers,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i6.Future<_i2.GraphQLResponse<T>>.value(_FakeGraphQLResponse_7<T>(
          this,
          Invocation.method(
            #query,
            [query],
...
/// A class which mocks [WeatherSqliteService].
///
/// See the documentation for Mockito's code generation for more information.
class MockWeatherSqliteService extends _i1.Mock
    implements _i7.WeatherSqliteService {
